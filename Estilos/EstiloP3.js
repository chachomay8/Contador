...
const styles = StyleSheet.create({
  ...
  // Fila superior — mitad de pantalla
  rowTop: {
    flexDirection: 'row',
    flex: 1,
    width: '100%',
  ...
  // Botones verticales (jugadores laterales)
  buttonTop: {
    flex: 1,
  ...
  // Botones horizontales (jugador abajo)
  buttonLeft: {
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
