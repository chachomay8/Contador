...
const styles = StyleSheet.create({
  ...
  // Jugador izquierda — botones arriba y abajo, mira hacia la derecha
  playerBoxL: {
    flex: 1,
    flexDirection: 'column',   // ← botones en columna
    backgroundColor: '#3b6ac0',
  },
  // Jugador derecha — igual pero número rotado al revés
  playerBoxR: {
    flex: 1,
  ...
  // Botones verticales (para jugadores laterales)
  buttonTop: {
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
    alignSelf: 'stretch',
    // debugear el tamaño del botón con un fondo temporal
...
symbol90: {
  ...
  color: '#ffffff',
  fontWeight: 'bold',
  transform: [{ rotate: '90deg' }],   // ← jugador izquierda
},
symbol270: {
  fontSize: 40,
  color: '#ffffff',
  fontWeight: 'bold',
  transform: [{ rotate: '270deg' }],  // ← jugador derecha
},
  menuButton: {
    paddingVertical: 8,
